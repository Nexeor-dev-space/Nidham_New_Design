...
/**
 * Closing CTA — a large cinematic section mirroring the homepage brand button
 * exactly (magnetic + shimmer + ripple + arrow). The headline reveals on scroll;
 * the action glides back up to the registration form on this page.
 */
export default function RegisterCTA() {
  ...
  return (
    <section
      ref={scopeRef}
      aria-label="Complete your registration"
