...
/**
 * Closing CTA — a large, cinematic section that mirrors the homepage's brand
 * button exactly (magnetic + shimmer + ripple + arrow). The headline mask-reveals
 * on scroll; ambient magenta glow keeps it consistent with the rest of the page.
 */
    ...
    >
      ...
      <div className="container-page relative flex flex-col items-center py-8 text-center sm:py-12 lg:py-16">
        ...
        <div data-reveal="up" className="mt-10 sm:mt-12">
          <BrandButton label={CTA_BUTTON_LABEL} size="lg" onClick={openContact} />
        </div>
      </div>
    </section>
  );
